...
{
    internal class LastCreatedQueueProxy : IModel
    {
        private readonly IModel inner;

        public QueueDeclareOk LastCreatedQueue { get; private set; }

        public LastCreatedQueueProxy(IModel inner)
        {
            this.inner = inner;
        }
        ...
        {
            return LastCreatedQueue = inner.QueueDeclare();
        }

        public QueueDeclareOk QueueDeclarePassive(string queue)
        {
            return LastCreatedQueue = inner.QueueDeclarePassive(queue);
        }

        public QueueDeclareOk QueueDeclare(string queue, bool durable, bool exclusive, bool autoDelete, IDictionary arguments)
        {
            return LastCreatedQueue = inner.QueueDeclare(queue, durable, exclusive, autoDelete, arguments);
        }
