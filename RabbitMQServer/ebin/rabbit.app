{application,rabbit,
    [{description,"RabbitMQ"},
     ...
     {vsn,"2.7.9"},
     {modules,
         [credit_flow,delegate,delegate_sup,file_handle_cache,gatherer,
          ...
          pg_local,priority_queue,rabbit,rabbit_access_control,rabbit_alarm,
          rabbit_amqqueue,rabbit_amqqueue_process,rabbit_amqqueue_sup,
          ...
          rabbit_backing_queue,rabbit_backing_queue_qc,rabbit_basic,
          rabbit_binary_generator,rabbit_binary_parser,rabbit_binding,
          rabbit_channel,rabbit_channel_sup,rabbit_channel_sup_sup,
          rabbit_client_sup,rabbit_command_assembler,rabbit_connection_sup,
          rabbit_control,rabbit_ctl_usage,rabbit_direct,rabbit_error_logger,
