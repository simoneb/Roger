    ...
    [{description,"RabbitMQ"},
     ...
     {modules,
         [bpqueue,delegate,delegate_sup,file_handle_cache,gatherer,
          gen_server2,gm,gm_soak_test,gm_speed_test,gm_tests,pg_local,
          priority_queue,rabbit,rabbit_access_control,rabbit_alarm,
          ...
          rabbit_ctl_usage,rabbit_direct,rabbit_error_logger,
          ...
          rabbit_exchange_type_topic,rabbit_framing,rabbit_framing_amqp_0_8,
          rabbit_framing_amqp_0_9_1,rabbit_guid,rabbit_heartbeat,
          rabbit_limiter,rabbit_log,rabbit_memory_monitor,rabbit_misc,
          ...
          rabbit_node_monitor,rabbit_prelaunch,rabbit_queue_collector,
