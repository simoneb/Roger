{application,rabbit,
    [{description,"RabbitMQ"},
     ...
     {vsn,"2.7.1"},
     {modules,
         [delegate,delegate_sup,file_handle_cache,gatherer,gen_server2,gm,
          gm_soak_test,gm_speed_test,gm_tests,lqueue,mirrored_supervisor,
          mirrored_supervisor_tests,pg2_fixed,pg_local,priority_queue,rabbit,
          rabbit_access_control,rabbit_alarm,rabbit_amqqueue,
          rabbit_amqqueue_process,rabbit_amqqueue_sup,rabbit_auth_backend,
          ...
          rabbit_networking,rabbit_node_monitor,rabbit_plugins,
